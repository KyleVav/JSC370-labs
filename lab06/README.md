...
# Finding the counts
counts <- xml2::xml_find_first(website, "/html/body/main/div/div/div/div/div/h3/span")
...
189 do not have abstracts.

Now, the title

``` r
titles <- stringr::str_extract(pub_char_list, "<AbstractTitle>.*</AbstractTitle>")
titles <- stringr::str_remove_all(titles, "<AbstractTitle>|</AbstractTitle>")
sum(is.na(abstracts))
```

- How many of these don’t have a title ?

189 do not have titles.
...
knitr::kable(database) |> kableExtra::scroll_box()
```
